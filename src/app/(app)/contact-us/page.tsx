    ...
    <section className="bg-muted py-8 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="relative w-full max-lg:max-h-70 aspect-[4/3]">
            <Image
              src="/contact-us.webp"
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-10 text-lg font-medium">
              We at Real Estate are here to help you find your dream home. We offer a wide range of
              properties tailored to your needs. From modern apartments to luxury villas, find your
              perfect space.
            </p>
